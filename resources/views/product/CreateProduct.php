                    ...
                    <form action="{{ route('product.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}"
                                   ...
                                   {{ $errors->has('name') ? 'border-red-500 bg-red-50/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }}
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="quantity" name="quantity" value="{{ old('quantity') }}"
                                       placeholder="0" min="0"
                                       class="w-full px-4 py-2.5 rounded-lg border text-sm
                                       {{ $errors->has('quantity') ? 'border-red-500 bg-red-50/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }}
                                       text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500
                                       focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
                                @error('quantity')
                                    <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price') }}"
                                       ...
                                       class="w-full px-4 py-2.5 rounded-lg border text-sm
                                       {{ $errors->has('price') ? 'border-red-500 bg-red-50/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }}
                                       text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500
                                       focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
                                @error('price')
                                    <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <select id="user_id" name="user_id"
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm
                                    {{ $errors->has('user_id') ? 'border-red-500 bg-red-50/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }}
                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Update details for <span class="font-medium text-gray-700 dark:text-gray-200">{{ $product->name }}</span></p>
                        </div>
                    </div>
